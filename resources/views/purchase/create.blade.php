    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.getElementById('add-product').addEventListener('click', function() {
        ...
        productRow.innerHTML = `
            ...
            <input type="date" name="products[${productIndex}][expired_date]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Tanggal Kadaluarsa">
            <input type="number" name="products[${productIndex}][buy_price]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Harga Beli" oninput="calculateSubTotal(${productIndex})">
      ...
      window.calculateSubTotal = function(index) {
        ...
        const buyPrice = document.querySelector(`[name="products[${index}][buy_price]"]`).value;
        const subTotal = (quantity && buyPrice) ? quantity * buyPrice : 0; // Cek jika nilai ada
